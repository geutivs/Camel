...
public class BarcodeSigninHandler {

	private static final String TAG = "BarcodeSigninHandler";

	private Context ctx;
	private String barcode;
	private ProgressDialog inProgressDialog;

	public BarcodeSigninHandler(String barcode, Context context) {
		this.barcode = barcode;
		this.ctx = context;
	}

	public void doBarcodeSignin() {
		showProgressDialog();
		new UploadBarcodeTask().execute();
	}
	...
	private class UploadBarcodeTask extends AsyncTask<Void, Void, String> {
